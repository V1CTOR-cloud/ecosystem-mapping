...
<Meta
  title="Mapping App/Basic/Picker/Location/Overview"
...
<Story
  id="mapping-app-basic-picker-location-unique-location--without-initial-value"
  height="250px"
  inline={false}
  loaders={[
    async () => ({
...
[See the args table of this component](?path=/docs/mapping-app-basic-picker-location-unique-location--without-initial-value)
...
<Story
  id="mapping-app-basic-picker-location-unique-location--with-initial-value"
  height="250px"
  inline={false}
  loaders={[
    async () => ({
...
[See the args table of this component](?path=/docs/mapping-app-basic-picker-location-unique-location--with-initial-value)
...
<Story
  id="mapping-app-basic-picker-location-multiple-locations--without-initials-values"
  height="200px"
  inline={false}
  loaders={[
    async () => ({
...
[See the args table of this component](?path=/docs/mapping-app-basic-picker-location-multiple-locations--without-initials-values)
...
<Story
  id="mapping-app-basic-picker-location-multiple-locations--with-one-initial-values"
  height="200px"
  inline={false}
  loaders={[
    async () => ({
...
[See the args table of this component](?path=/docs/mapping-app-basic-picker-location-multiple-locations--with-one-initial-values)
...
<Story
  id="mapping-app-basic-picker-location-multiple-locations--with-initials-values"
  height="200px"
  inline={false}
  loaders={[
    async () => ({
...
[See the args table of this component](?path=/docs/mapping-app-basic-picker-location-multiple-locations--with-initials-values)