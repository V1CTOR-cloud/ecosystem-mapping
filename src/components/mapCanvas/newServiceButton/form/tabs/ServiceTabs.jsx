...
*/}
          ...
          <Box marginTop={6}>
            <LabelWithTooltip
              label={t("Service Focus")}
              tooltipAriaLabel={t("Service Focus")}
              tooltipText={t("Service focus tooltip")}
            />
        ...
        <TabPanel>
          ...
          <Box marginTop={3}>
            ...
            <LabeledInputComponent
              ...
              onChange={(organisation) => formValue.ownerOrganization = organisation}
            />
