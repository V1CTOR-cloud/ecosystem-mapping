...
import { FormControl, FormLabel, Box, Flex, Tooltip } from "@chakra-ui/react";
  ...
  return (
    <Box>
      <FormControl>
        ...
        <Flex>
          <Box flex="1">
            <FormLabel mr="-60px" className="txt-cn" style={checkSubLabelStyle}>
        ...
        <Box mt="20px">
          <p className="tooltipsdk">
            ...
            <Box ml="10px" display="inline">
              <Tooltip label="-2:Ideating; -1:Concepting; 0:Committing; 1:Validating; 2:Scaling; 3:stablishing">
                <QuestionIcon />
              </Tooltip>
            </Box>
          </p>
