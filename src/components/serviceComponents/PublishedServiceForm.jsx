              ...
              <Flex>
                ...
                >
                  ...
                  <Box m="0px" className="pf-gry-crd" mb="5">
                    <Text fontSize="ml">
                      {t(
                        "startup.popup.service.details.content.application.type"
                      )}
                      :{" "}
                  ...
                  <Box className="pf-gry-crd" mb="5">
                    <Text fontSize="ml">
                      {t(
                        "startup.popup.service.details.content.service.category"
                      )}
                      :{" "}
                      <Grid
                      ...
                      <Text>
                        {orgName.onlineService && (
                          <Box>
                            ...
                            <Tag fontWeight="bold">
                              {t(
                                "startup.popup.service.details.content.online"
                              )}{" "}
                              -
                            </Tag>{" "}
                            <Text ml="9px">
                ...
                >
                  <Box ml="28px" className="pf-gry-crd" mb="5">
                    <Text fontSize="ml">
                      {t(
                        "startup.popup.service.details.content.precedes.service"
                      )}
                      :
                    </Text>
                  ...
                  <Box ml="28px" className="pf-gry-crd" mb="5">
                    <Text fontSize="ml">
                      {t(
                        "startup.popup.service.details.content.follows.service"
                      )}
                      :
                    </Text>
                  ...
                  <Box ml="28px" className="pf-gry-crd" mb="5">
                    <Text fontSize="ml">
                      {t(
                        "startup.popup.service.details.content.service.description"
                      )}
                      :
                    </Text>
                  ...
                  <Box
                    ...
                    mt="128"
                  >
                    <span className="lbl-progress-txt">
                      {t("startup.popup.service.details.content.progress")}
                    </span>{" "}
                    &nbsp;
                    <Box>
                ...
                >
                  <Box ml="28px" className="pf-gry-crd" mb="5">
                    <Text fontSize="ml">
                      {t("startup.popup.service.details.content.user.expect")}:
                    </Text>
                  ...
                  <Box ml="28px" className="pf-gry-crd" mb="5">
                    ...
                    <Text>
                      <ServiceChangesLog
                        allComments={orgName.serviceComments}
                      />
                    </Text>
                  </Box>
                  <Box ml="28px" className="pf-gry-crd" mb="5">
                    <Text fontSize="ml">
                      ...
                      <Tag fontWeight="bold">{orgName.timezone}</Tag>
                    </Text>
                  </Box>
                  <Box ml="28px" className="pf-gry-crd" mb="5">
                    <Text fontSize="ml">
                      {t(
                        "startup.popup.service.details.content.service.status"
                      )}
                      : <Tag fontWeight="bold">{orgName.serviceStatus}</Tag>
                    </Text>
                  </Box>
                </Box>
              </Flex>
